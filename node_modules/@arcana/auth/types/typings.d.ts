...
export declare type Network = 'dev' | 'testnet' | 'mainnet';
export declare type SDKVersion = 'v3';
...
export interface IframeWrapperParams {
    ...
    standaloneMode?: {
        mode: 1 | 2;
        handler: (t: string, val: unknown) => void;
    };
}
...
export declare type Logins = 'google' | 'github' | 'discord' | 'twitch' | 'twitter' | 'aws' | 'firebase' | 'steam';
export declare enum BearerAuthentication {
    firebase = "firebase"
}
export declare type FirebaseBearer = {
    uid: string;
    token: string;
};
